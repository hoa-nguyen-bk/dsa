...
public:
  ...
  //đối với việc xóa chỉ cần xóa 2 thằng thôi, thứ nhất là del H thứ 2 là del remain tại vì thằng giữa thằng cúi như nhau ò
  void delR(T delData){
    cout << "head = " << head << endl;
    // nhớ với tạo tmp thì tạo như ri nha 
    Node<T> *tmp = head;
