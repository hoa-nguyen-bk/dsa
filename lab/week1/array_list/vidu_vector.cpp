...
int main()
{
  ...
  vec.push_back(24);
  int s = vec.size();
  cout << "nThe last element is: " << vec[s - 1] << endl;

  // prints the vector
  cout << "nThe vector elements after push back are: " << endl;
  ...
  // prints the vector
  cout << "nThe vector elements after pop_back are: " << endl;
  for (int i = 0; i < vec.size(); i++)
    cout << vec[i] << " " << endl;
  ...
  cout << "nAfter Swap nVector 1: " << endl;
  for (int i = 0; i < obj1.size(); i++)
    cout << obj1[i] << " " << endl;
